...
_MIGRATION_TABLE = {
    ...
    "009_create_nordstrom_womens_dresses.sql": "nordstrom_womens_dresses",
...
_PLATFORM_COLS = {
    "id", "platform_id", "gender_id", "category", "url", "title", "brand",
    "description", "sub_category", "currency",
    "current_price", "original_price", "discount_percent", "rating", "review_count",
    "color", "size", "neck_type", "dress_length", "occasion", "fit",
    "pattern", "closure_type", "material", "care_instructions", "sleeve_type",
    "attributes_json", "stock_variants_json", "review_json", "raw_json",
    "data_label", "poc_run_id", "is_active", "scraped_at", "updated_at",
}
